...
class MemberRepositoryTest {
    ...
    @Test
    void findByUsernameAndAgeGraterThan() throws Exception {
    ...
    public void bulkUpdate() {
        //spring data jpa는 @Modifying 어노테이션 써줘야 한다.
        memberRepository.save(new Member("member1", 10));
        ...
        /**
         * 벌크연산은 영속성 컨텍스트를 거치지 않고 Db에 바로 쏜다.
         * 벌크 연산 이후에는 영속성 컨텍스트를 날려야한다.
         * 벌크연산 이후에 아무것도 안하는 작업이면 상관없는데 이후 로직이 있으면 flush clear 해야함.
         * data jpa에서는 @Modifying(clearAutomatically = true) 해주면 된다.
         */
...
//        em.clear();
    ...
    void findMemberLazy() throws Exception {
        ...
        //when N+1
        //select Member! 이게 1   여기서 멤버는 1번 조회하는데 팀은 2번 조회하니까 팀이 N
//        List<Member> members = memberRepository.findAll();
    ...
    @Test
    void nativeProjectionsQuery() throws Exception {
        Team teamA = new Team("teamA");
        em.persist(teamA);
